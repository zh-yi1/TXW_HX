...
/** @addtogroup es32f0283
  * @{
  */

#ifndef __ES32F0283_H__
#define __ES32F0283_H__
...
#include "reg_spi.h"
#include "reg_i2c.h"
#include "reg_ad16c4t1.h"
#include "reg_gp32c4t1.h"
#include "reg_gp16c4tn.h" 
#include "reg_gp16c2tn.h"
#include "reg_bs16t1.h"
#include "reg_wwdt.h"
#include "reg_iwdt.h"
#include "reg_adc.h"
#include "reg_cmp.h"
...
#define AD16C4T1          (( AD16C4T1_TypeDef  *) AD16C4T1_BASE)
#define SPI1              (( SPI_TypeDef      *)     SPI1_BASE)
#define UART1             (( UART_TypeDef     *)    UART1_BASE)
#define GP16C2T1          (( GP16C2Tn_TypeDef  *) GP16C2T1_BASE)
#define GP16C2T2          (( GP16C2Tn_TypeDef  *) GP16C2T2_BASE)
#define GP16C2T3          (( GP16C2Tn_TypeDef  *) GP16C2T3_BASE)
#define GP16C2T4          (( GP16C2Tn_TypeDef  *) GP16C2T4_BASE)
#define CMP               (( CMP_TypeDef      *)     CMP_BASE)

#define GP32C4T1          (( GP32C4T1_TypeDef  *) GP32C4T1_BASE)
#define GP16C4T1          (( GP16C4Tn_TypeDef  *) GP16C4T1_BASE)
#define GP16C4T2          (( GP16C4Tn_TypeDef  *) GP16C4T2_BASE)
#define GP16C4T3          (( GP16C4Tn_TypeDef  *) GP16C4T3_BASE)
#define BS16T1            (( BS16T1_TypeDef    *)   BS16T1_BASE)
