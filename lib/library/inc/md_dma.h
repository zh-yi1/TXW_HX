...
typedef enum
{
    ...
    MD_DMA_MSEL_USART0  = 0x4U, /**< USART0 */
    MD_DMA_MSEL_USART1  = 0x5U, /**< USART1 */
    MD_DMA_MSEL_I2C1    = 0x6U, /**< I2C1 */
    MD_DMA_MSEL_SPI0    = 0x7U, /**< SPI */
    MD_DMA_MSEL_I2C0    = 0x8U, /**< I2C0 */
    MD_DMA_MSEL_AD16C4T = 0x9U, /**< AD16C4T */
    MD_DMA_MSEL_GP16C2T0 = 0xAU, /**< GP16C2T0 */
    MD_DMA_MSEL_GP16C2T1 = 0xBU, /**< GP16C2T1 */
    MD_DMA_MSEL_GP16C2T2 = 0xCU, /**< GP16C2T2 */
    MD_DMA_MSEL_PIS     = 0xDU, /**< PIS */
    MD_DMA_MSEL_BSTIM0  = 0xEU, /**< BSTIM0 */
} md_dma_msel_t;
...
{
	WRITE_REG(DMA0->CHENCLR, channel);
}
