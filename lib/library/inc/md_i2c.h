...
typedef enum
{
    MD_I2C_STRETCH_DISABLE = 0x80U,    /**< stretch disable */
    MD_I2C_STRETCH_ENABLE  = 0x0U,   /**< stretch enable */
} md_i2c_stretch_t;
...
typedef struct
{
    ...
    md_i2c_stretch_t stretch;      /**< Specifies if nostretch mode is selected */
} md_i2c_init_t;
...
{
    return READ_BIT(i2c->ADDR1, I2C_ADDR1_ADDLSB_MSK);
}
