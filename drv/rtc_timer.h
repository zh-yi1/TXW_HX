 ...
 *  │    每条 16B, 每块 16 条          │
 *  │    共 1008 条, 满后擦最旧块环形覆盖│
 *  ├─────────────────────────────────┤ +0x7000  ← FLASH_OFFS_ABNORMAL_TEMPERATURE
 *  │  ■ 温度异常固定区 (63 × 256B)    │
 *  │    每条 16B, 每块 16 条          │
 *  │    共 1008 条, 满后擦最旧块环形覆盖│
 *  │                                │
...
/* ---- 异常记录区 ---- */
#define FLASH_OFFS_ABNORMAL_VOLTAGE     (0x3000)      /* 电压异常固定区 (63 块) */
#define FLASH_OFFS_ABNORMAL_TEMPERATURE (0x7000)      /* 温度异常固定区 (63 块) */
