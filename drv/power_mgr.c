...
static void power_mgr_io_low_power_config(void)
{
    ...
    GPIOA->MODE &= ~(MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_1)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_7)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_8)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_9)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_10)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_11)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_12)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_14));

    /* PA5(I2C1 SCL)/PA6(I2C1 SDA) — 外部上拉, 模拟模式安全 */
    GPIOA->MODE &= ~(MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_5)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_6));

    /* PB0(USART RX)/PB1(USART TX)/PB5(SW_SCL) */
    GPIOB->MODE &= ~(MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_0)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_1)
                   | MD_GPIO_PIN_TWO_MSK(MD_GPIO_PIN_5));
...
void power_mgr_proc(void)
{
    ...
    uint8_t usb_active = (ui_data.usb_c1_status != 0
